        ...
        >
          ...
          <div className="mt-8 flex flex-wrap items-center gap-3">
            ...
            >
              ...
              href={site.phoneHref}
              className="inline-flex items-center gap-2.5 rounded-full bg-black/30 px-6 py-3 text-sm font-bold text-white backdrop-blur-md transition duration-200 hover:scale-[1.03] hover:bg-white/10 hover:shadow-[0_0_20px_rgba(180,255,0,0.25)]"
