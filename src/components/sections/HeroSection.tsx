        ...
        >
          ...
          <div className="mt-8 flex flex-wrap items-center gap-3">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex items-center gap-2.5 rounded-full bg-black/30 px-7 py-3 text-sm font-black tracking-wide text-volt backdrop-blur-md transition duration-200 hover:scale-[1.03] hover:bg-volt hover:text-graphite hover:shadow-[0_0_28px_rgba(180,255,0,0.55)] active:scale-95"
            ...
            <a
              href={site.phoneHref}
              className="inline-flex items-center gap-2.5 rounded-full bg-black/30 px-6 py-3 text-sm font-bold text-volt backdrop-blur-md transition duration-200 hover:scale-[1.03] hover:bg-volt hover:text-graphite hover:shadow-[0_0_28px_rgba(180,255,0,0.55)]"
              style={{ border: "1.5px solid rgba(180,255,0,0.6)" }}
            >
