        ...
        >
          ...
          <div className="mt-8 flex flex-wrap items-center gap-3">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex items-center gap-2.5 rounded-full bg-volt px-7 py-3 text-sm font-black tracking-wide text-graphite transition duration-200 hover:scale-[1.03] hover:shadow-[0_0_28px_rgba(180,255,0,0.55)] active:scale-95"
            >
